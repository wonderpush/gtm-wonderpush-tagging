...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "WonderPush - Manage tags and properties",
  "brand": {
    "id": "brand_dummy",
    "displayName": "",
  ...
  "description": "Manipulate tags and properties inside WonderPush, in order to target push notifications based on user profile.\nRequires the \"WonderPush - Integrate Web Push Notifications\" template.",
...
[
  {
    ...
    "help": "See https://docs.wonderpush.com/docs/tags for more information."
  },
  {
    "type": "PARAM_TABLE",
    "name": "properties",
    ...
    "paramTableColumns": [
      ...
      },
      {
        "param": {
          ...
          "simpleValueType": true,
          "help": "\"Set\" assigns the value to the property.\n\"Unset\" removes any value to the property.\n\"Add\" adds the value to the list of values of the property.\n\"Remove\" removes the value from the list of values of the property.\nSee https://docs.wonderpush.com/docs/properties for more information."
        },
        "isUnique": false
      },
      {
    ...
    "help": "See https://docs.wonderpush.com/docs/properties for more information."
  }
]
...
tags.forEach(item => {
  ...
  if (action) callInWindow('WonderPush.push', [action, item.tag]);
});
...
properties.forEach(item => {
  ...
  if (item.action === 'add') {
    ...
    action = 'setProperty';
  } else if (item.action === 'unset') {
    action = 'unsetProperty';
  }
  const underscorePos = item.property.indexOf('_');
  const prefix = item.property.substring(0, underscorePos);
  switch (prefix) {
    case 'byte':
    case 'short':
    case 'int':
  ...
  if (action) callInWindow('WonderPush.push', [action, item.property, item.value]);
});
...
Created on 12/3/2019, 12:41:07 PM
